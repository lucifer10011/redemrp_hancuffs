...
RegisterNetEvent('redemrp_handcuffs:handcuffItem')
AddEventHandler('redemrp_handcuffs:handcuffItem', function()
    CuffsMenu()
end)
    ...
    MenuData.Open(
        ...
        function(data, menu)
            if data.current.value == "cuff_item" then
                ...
                TriggerServerEvent('redemrp_handcuffs:handcuffIt', GetPlayerServerId(closestPlayer))
            ...
            elseif data.current.value == "put_bag" then
                ...
                if IsPedCuffed(GetPlayerPed(closestPlayer))  or IsEntityDead(GetPlayerPed(closestPlayer)) then
                    TriggerServerEvent('redemrp_handcuffs:putBag', GetPlayerServerId(closestPlayer))
                end
            end
        end,
